...
test("property enumeration", function () {
    ...
    deepEqual(keys, ["name", "age", "unemployed"], "what are the property names of the object?");
    deepEqual(values, ["Amory Blaine", 102, true], "what are the property values of the object?");
});
